...
<head>
  ...
  <div style="text-align: center;">
    ...
    <table align="center" style="text-align: center; vertical-align: top; width: 600px; max-width: 600px; background-color: #ffffff;" width="600">
      <tbody>
        <tr>
          <td style="width: 596px; vertical-align: top; padding-left: 0; padding-right: 0; padding-top: 1px; padding-bottom: 1px;" width="596">

            <!-- Your logo is here -->
            <img style="width: 180px; max-width: 180px; height: 180px; max-height: 180px; text-align: center; color: #ffffff;" alt="Logo" src="https://team.flymingotech.in/azamDeals/public/files/villa/base_image/1681202776_jalanata_lo.png" align="center" width="180" height="85">
    ...
    <!-- Hero image -->
    <img style="width: 600px; max-width: 600px; height: 350px; max-height: 350px; text-align: center;" alt="Hero image" src="https://team.flymingotech.in/azamDeals/public/files/villa/base_image/1681028682_Lonavala-scaled%20(1).jpg" align="center" width="600" height="350">
    <!-- Hero image -->
    ...
    <table align="center" style="text-align: center; vertical-align: top; width: 600px; max-width: 600px; background-color: #ffffff;" width="600">
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
              ...
              <h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Lonavala Hills</h1>

              <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">Your Booking Successful</p>              
      ...
      <!-- Start image -->
      <img style="width: 600px; max-width: 600px; height: 240px; max-height: 240px; text-align: center;" alt="Image" src="https://team.flymingotech.in/azamDeals/public/files/villa/base_image/1681026654_Mahableshwar%20(1).jpg" align="center" width="600" height="240">
      <!-- End image -->
      ...
      <!-- Start image -->
      <img style="width: 600px; max-width: 600px; height: 240px; max-height: 240px; text-align: center;" alt="Image" src="https://team.flymingotech.in/azamDeals/public/files/villa/base_image/1681026283_pawana-lake%20(1).jpg" align="center" width="600" height="240">
      <!-- End image -->
      ...
      <table align="center" style="text-align: center; vertical-align: top; width: 600px; max-width: 600px; background-color: #ffffff;" width="600">
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 1px; padding-bottom: 0px;" width="596">
